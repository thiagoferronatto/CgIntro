...
inline interval::interval(double l, double h) : lo(l), hi(h) {}

// Get the lower bound of an interval

inline double interval::left() const { return lo; }

// Get the higher bound of an interval

inline double interval::right() const { return hi; }

// Calculate the width of an interval

inline double interval::width() const { return (hi - lo); }
