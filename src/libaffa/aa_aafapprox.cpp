...
AAF AAF::operator/(const AAF& P) const { return (*this) * inv(P); }
...
AAF sqr(const AAF& P) { return P * P; }
...
AAF pow(const AAF& P, double xp) { return exp(xp * log(P)); }
